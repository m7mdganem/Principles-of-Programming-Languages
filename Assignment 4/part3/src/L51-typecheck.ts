...
import { isProcTExp, makeBoolTExp, makeNumTExp, makeProcTExp, makeStrTExp, parseTE, 
         unparseTExp, BoolTExp, NumTExp, StrTExp, TExp, VoidTExp } from "./TExp51";
...
import * as T from "./L51-typeinference";
